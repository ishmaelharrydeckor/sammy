...
export default function Home() {
  ...
  return (
    <div ref={containerRef} className="relative min-h-screen bg-background text-[#E2E2E2] overflow-x-hidden">
      ...
      <section
        id="hero"
        className="relative min-h-[75vh] md:min-h-[80vh] w-full flex flex-col justify-center items-center py-12 md:py-18 z-10 bg-black"
      >
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 lg:px-8 w-full">
          <div className="max-w-5xl flex flex-col items-start justify-center text-left">
            <span className="hero-subtitle text-[11px] sm:text-xs font-light tracking-[0.25em] text-[#C5A059] uppercase mb-3 md:mb-5 block text-left">
              {content.hero.subtitle}
            </span>
            <h1 className="hero-title text-3xl sm:text-5xl md:text-6xl lg:text-[4.25rem] font-black tracking-tight text-white leading-[1.1] mb-4 md:mb-6 max-w-5xl uppercase text-left">
              The Literal <span className="text-[#C5A059] font-black">Cheat Code</span> For <br className="hidden md:inline" />
              Business Growth.
            </h1>
            
            {content.hero.subtext && (
              <p className="hero-creds text-sm sm:text-base md:text-lg font-light text-white/80 leading-relaxed mb-6 md:mb-8 max-w-2xl text-left">
                {content.hero.subtext}
              </p>
            )}
